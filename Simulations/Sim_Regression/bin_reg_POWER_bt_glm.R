# Simulation of the Power in a regression model with the GLM and the Bootstrap method
...
write.csv(sim_mmm_bin_power_bt_glm_res, ".\\intermediate_results\\bin_reg_POWER_bt_glm_1.csv", row.names = FALSE)
