...
sim_mmm_bin_gc_h0801_ha204s02 <- function(method, 
  ...
  m2 <- matrix(rep(logit(0.4)+(0.2*c(0:3)), each = 2), ncol = length(di))
...
write.csv(sim_mmm_bin_gc_h0801_ha204s02_res, paste0(".\\intermediate_results\\bin_gc_ss_h08_01_ha2_04_s02_",args[1],".csv"), 
          row.names = FALSE)
